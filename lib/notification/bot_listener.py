...
from .commands._guard import init_guard
from .commands.system import job_llm_budget_alert

# ── Re-exports for backward compatibility (tests and external callers) ────────
from .commands.account import (  # noqa: F401
...
from .commands.market import (  # noqa: F401
    cmd_ltp, cmd_gainers, cmd_losers, cmd_watchlist, cmd_holidays,
    cmd_straddle, cmd_walls,
)
from .commands.system import cmd_help, cmd_status  # noqa: F401
